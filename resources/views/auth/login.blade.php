<x-guest-layout>
    ...
    <h1 style="font-weight: bold; color: black;">WELCOME BACK 🤝</h1>
</br>
    <p id="typing-text" class="text-black mb-4"></p>

<script>
    const text = "Log in to your account and continue the journey. ";
    let index = 0;
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-dark-400">{{ __('Remember me') }}</span>
            </label>
        </div>
